...
const IMPACTS = [
  {
    ...
    title: "Driving Measurable Gains Across Every Classroom",
  ...
  },
  {
    ...
    title: "Trusted by Schools & Institutions Nationwide",
  ...
  },
  {
    ...
    chip: "Our Legacy",
    title: "Decades of Leadership in Educational Consultancy",
    image: "/assets/impact-3.webp",
          ...
          <div className="grid h-full grid-cols-1 lg:grid-cols-[1.2fr_1fr]">
            ...
            <div className="relative flex min-h-0 flex-col bg-background lg:min-h-full">
              ...
              <div
                ...
                aria-atomic="true"
              >
                <div className="shrink-0 px-6 pb-4 pt-8 text-center sm:px-10 lg:px-8 lg:pb-6 lg:pt-12">
                  <AnimatePresence mode="wait" initial={false}>
                    <motion.div
                      key={activeImpact.metricLabel}
